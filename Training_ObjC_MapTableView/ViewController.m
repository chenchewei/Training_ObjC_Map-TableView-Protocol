...
/* 程式會使用到的各類變數 */
@property (strong, nonatomic) NSArray<NSString *> *stationNameArr;
@property (strong, nonatomic) NSArray<NSString *> *stationAddressArr;
...
- (void)viewDidLoad {
    [super viewDidLoad];
    /* Initializing datas */
    _stationNameArr = @[@"南港",@"台北",@"板橋",@"桃園",@"新竹",@"苗栗",@"台中",@"彰化",@"雲林",@"嘉義",@"台南",@"左營"];
    _stationAddressArr = @[@"台北市南港區南港路一段313號",@"台北市北平西路3號",@"新北市板橋區縣民大道二段7號",@"桃園市中壢區高鐵北路一段6號",@"新竹縣竹北市高鐵七路6號",@"苗栗縣後龍鎮高鐵三路268號",@"台中市烏日區站區二路8號",@"彰化縣田中鎮站區路二段99號",@"雲林縣虎尾鎮站前東路301號",@"嘉義縣太保市高鐵西路168號",@"台南市歸仁區歸仁大道100號",@"高雄市左營區高鐵路105號"];
